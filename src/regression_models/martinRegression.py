...
def combined_regression_modal(NowDateTime, AllOutPut, Regression_X_train, Regression_y_train):
    """
    ...
    joblib.dump(RegressionModel, f'./models/CombinedRegression.joblib')  # Changed to .joblib
    joblib.dump(LSTM_MinMaxModel, './models/Combined_MinMaxModel.joblib')  # Changed to .joblib
